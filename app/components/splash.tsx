...
export const SplashSection = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-stretch animate-slide-down-fade-3 w-full h-[100vh] 2xs:h-[75vh] md:h-[50vh] justify-between text-sm rounded-lg bg-slate-800 shadow-md-white">
        ...
        <div className="flex flex-1 bg-slate-700 rounded-br-lg rounded-bl-lg md:rounded-bl-none md:rounded-tr-lg"></div>
      </div>
    </>
  );
};
