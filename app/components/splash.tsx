...
export const SplashSection = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-stretch animate-slide-down-fade-3 max-w-5xl w-full h-[100vh] 2xs:h-[75vh] md:h-[50vh] justify-between text-sm rounded-lg bg-slate-700 shadow-md-white">
