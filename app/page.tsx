...
export default function Splash() {
  ...
  return (
    <main className="flex h-full flex-col items-center gap-10 p-5 md:p-10">
      <div className="flex animate-slide-down-fade max-w-5xl w-full p-3 pt-20 pb-10 shadow-md-white items-center justify-between font-mono text-sm rounded-lg bg-gradient-to-br from-red-500 to-orange-400">
